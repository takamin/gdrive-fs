 ...
 * @param {object} apiopts The option parameters.
 * @returns {Promise<Gdfs>} A Gdfs instance that the API client was initialized.
 */
Gdfs.loadApi = (apiopts) => {
    ...
    const p = new Promise( (resolve, reject) => {
        script.addEventListener("load", () => {
            ...
            gapi.load("client:auth2", async () => {
                ...
                await gapi.client.init(apiopts);
 ...
 */
Gdfs.getActualRootFolderId = async function() {
