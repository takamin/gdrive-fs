...
},{"./debug":"btPN","process":"g5I+"}],"bEsR":[function(require,module,exports) {
"use strict";
 ...
 *
 * For details of file operations,
 * see [readFile](#readFile), [writeFile](#writeFile),
 * [unlink](#unlink), [mkdir](#mkdir), [rmdir](#rmdir), and so on.
 *
 * @constructor
 */
...
Gdfs.prototype.mkdir = async function (pathname) {
  ...
  const result = await Gdfs.createFile(parentFolder.id, dirname, Gdfs.mimeTypeFolder);
